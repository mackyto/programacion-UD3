...
/**
 *
 * 6. Crea un programa que genere un número entero aleatorio (puedes usar la
 *    clase Random o el método Math.random) y le pida al usuario que intente
 *    adivinarlo. Si se introduce un número fuera del rango (1 a 10), debe 
